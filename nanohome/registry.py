...
APPS = (
    ...
    },
    {
        ...
        "name": "nanoShell",
        "emoji": "⌨️",
        "tagline": "Any program at all, with words instead of flags",
        "what": "Reads a program's own --help and turns it into a page of labelled boxes, so nobody has to learn the flags.",
        "you_can": [
            "Use any program on the computer without the terminal",
            "See the exact command before it runs",
            "Save a combination you like as one button",
        ],
        "port": 8767,
        "package": "nanoshell",
        "repo": "https://github.com/Agarwalrishu13/nanoshell",
    },
    {
        "id": "nanogit",
        "name": "nanoGit",
        "emoji": "🗂",
        "tagline": "Your folder, kept safe without learning git",
        "what": "Real git underneath, plain words on top: save a checkpoint, go back, put it online — and nothing is ever deleted.",
        "you_can": [
            "Keep a folder safe with buttons that say what they do",
            "Go back to any version without losing anything",
            "Put a folder online as a private GitHub repository",
        ],
        "port": 8778,
        "package": "nanogit",
        "repo": "https://github.com/Agarwalrishu13/nanogit",
    },
    {
        "id": "nanopick",
        "name": "nanoPick",
        ...
        "what": "A word from the name, roughly what kind, roughly when — and the file is on the page, ready to open or copy.",
        "you_can": [
            "Find a file with words, not paths",
            "See pictures and songs right on the page",
            "Send copies to a project folder, or pack a few into one zip",
        ],
        "port": 8779,
        "package": "nanopick",
        "repo": "https://github.com/Agarwalrishu13/nanopick",
    },
    {
        "id": "nanotune",
        "name": "nanoTune",
        ...
        "what": "Point it at a folder of music and press play — next, previous, shuffle, repeat, on your own computer.",
        "you_can": [
            "Play the songs already on this machine",
            "Mix them up with shuffle, or repeat them all",
            "Jump straight to a song's folder",
        ],
        "port": 8776,
        "package": "nanotune",
        "repo": "https://github.com/Agarwalrishu13/nanotune",
    },
)
...
COMPANIONS = (
    ...
    },
    {
        ...
        "what": "SFT and DPO alignment for tiny models, written from scratch — the step between completing text and answering.",
    ...
    },
    {
        ...
        "name": "nanoforge",
        "emoji": "🏗",
        "tagline": "The offline studio for tiny models",
        "what": "Describe an architecture, train it, and export it to the engine — a workshop for people who want to see the gears.",
        "repo": "https://github.com/Agarwalrishu13/nanoforge",
    },
)
